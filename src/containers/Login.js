                ...
                <div className="card-content">
                    <div className="content">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className={`input ${errors.username ? "is-danger" : ""}`} type="text"
                                           name="username" ref={register({required: "Your username is required!"})}/>
                                    {errors.username &&
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className={`input ${errors.password ? "is-danger" : ""}`} type="password"
                                           name="password" ref={register({required: "Your password is required!"})}/>
                                    {errors.password &&
                            ...
                            {failedMessage && <div className="notification is-light is-danger">{failedMessage}</div>}
                        </form>
                    </div>
                </div>
            </div>
